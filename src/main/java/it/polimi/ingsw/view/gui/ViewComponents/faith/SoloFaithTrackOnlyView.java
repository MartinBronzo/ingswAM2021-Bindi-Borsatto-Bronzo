...
public class SoloFaithTrackOnlyView extends JPanel{
    ...
    private void addFaithTrack() {
        ...
        Game game = PanelManager.getInstance().getGameModel();
        JLabel lorenzosPosition = new JLabel("Lorenzo's position: " + game.getLorenzosPosition());
        lorenzosPosition.setBorder(new TitledBorder("Lorenzo's position"));
        infoPanel.add(lorenzosPosition);
