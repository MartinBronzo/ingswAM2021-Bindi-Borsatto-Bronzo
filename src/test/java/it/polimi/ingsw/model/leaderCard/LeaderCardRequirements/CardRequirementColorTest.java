...
class CardRequirementColorTest {
    ...
    @Test
    void getCardColour() {
        Assertions.assertEquals(DevCardColour.GREEN, requirement1.getCardColour());
        Assertions.assertEquals(DevCardColour.BLUE, requirement2.getCardColour());
    }
    ...
    public void checkCloning() throws NegativeQuantityException {
        ...
        Assertions.assertEquals(clone.getCardColour(), requirement1.getCardColour());
