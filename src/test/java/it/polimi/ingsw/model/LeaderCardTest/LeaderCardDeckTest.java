...
public class LeaderCardDeckTest {
    ...
    public void ctrlEqualsTrue() throws NegativeQuantityException, ParserConfigurationException, IOException, SAXException {
        LeaderCardDeck l1 = new LeaderCardDeck(LeaderCardDeck.initLeaderCards(this.getClass().getResourceAsStream("/XMLs/LeaderCardConfig.xml")));
        LeaderCardDeck l2 = new LeaderCardDeck(LeaderCardDeck.initLeaderCards(this.getClass().getResourceAsStream("/XMLs/LeaderCardConfig.xml")));
